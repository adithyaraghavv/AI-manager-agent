...
export default function DocumentSearch() {
  ...
  return (
    <div className="doc-search">
      ...
      {error && (
        <div className="doc-search__status doc-search__status--error">
          {error}
        </div>
      )}
      {!searching && !error && results !== null && (
        <div className="doc-search__results">
          {results.length === 0 ? (
            <div className="doc-search__status">
              ...
              return (
                <div key={i} className="doc-search__result-wrap">
                  <div className="doc-search__result">
                    <a
                      className="doc-search__result-link"
                      href={r.download_url}
                      download
                    >
                    ...
                    >
                      <span className="doc-search__version-count">
                        {r.version_count}{" "}
                        {r.version_count === 1 ? "version" : "versions"}
                      </span>
